...
@interface HinosDetailViewController ()<UIWebViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIGestureRecognizerDelegate,GADBannerViewDelegate, UITableViewDataSource,UITableViewDelegate> {
    ...
    __weak IBOutlet NSLayoutConstraint *_heightViewPlayMusicConstraint;
...
- (void)viewDidLoad {
    ...
    if ([[Reachability reachabilityForInternetConnection] currentReachabilityStatus] == NotReachable) {
        ...
        _heightViewPlayMusicConstraint.constant = 0.0f;
        _viewPlayMusic.hidden = YES;
    } else {
        _heightBannerConstraint.constant = 50.0f;
        _bannerView.hidden = NO;
        _heightViewPlayMusicConstraint.constant = 50.0f;
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [tracker set:kGAIScreenName value:@"iOS - Song Details"];
    ...
    if (indexPath.section == 0) {
        ...
        switch (indexPath.row) {
            ...
            case 1:
                ...
                // Choose the item number 2: "Favoritos"
            ...
            case 2:
                ...
                // Choose the item number 5: "Ajustes"
                [self.navigationController popToRootViewControllerAnimated:NO];
